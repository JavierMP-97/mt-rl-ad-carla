...
class SACWithVAE(SAC):
    ...
    def initialize(self, path):
        ...
        if not os.path.isfile(self.file_path+".txt"):
            with open(self.file_path+".txt", "a+") as f:
                f.write("episode,ticks,acum_reward,capped_acum_reward,avg_reward,total_ticks,success\n")
                f.close()    
        ...
        with TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name) as writer:
            ...
            for step in range(total_timesteps):
                ...
                if info["success"] == 1:
                    ...
                    print("BIEEEEEEEEEEEEEEEEEEEEEN")
                else:
                    success = False
                ...
                if done:
                    ...
                    with open(self.file_path+".txt", "a") as f:
                        f.write("{},{},{},{},{},{},{}\n".format(episode, ep_len-1, episode_rewards[-1], max(0, episode_rewards[-1]-3000), episode_rewards[-1] / max(1,(ep_len-1)), step, info["success"] | int(ep_len > self.train_freq)))
                        f.close()
